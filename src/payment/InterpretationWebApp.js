...
const styles = StyleSheet.create({
  ...
  topNav: { position: 'sticky', top: 0, zIndex: 30, borderBottomWidth: 1, borderBottomColor: 'rgba(21,29,51,0.06)', backgroundColor: 'rgba(255,255,255,0.98)' }, topNavInner: { minHeight: 82, paddingHorizontal: 20, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 18 }, topNavInnerMobile: { minHeight: 0, flexDirection: 'column', alignItems: 'stretch', gap: 12, paddingHorizontal: 14, paddingTop: 10, paddingBottom: 12 }, topNavMainRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }, brandLockup: { flexDirection: 'row', alignItems: 'center', gap: 12, minWidth: 0, flexShrink: 1 }, brandLogo: { width: 52, height: 52, borderRadius: 14, backgroundColor: '#0d1930' }, brandTitle: { color: '#171b31', fontSize: 24, lineHeight: 28, fontWeight: '800' }, brandSubtitle: { color: '#69708b', fontSize: 14, lineHeight: 18, fontWeight: '700' }, navRow: { flexGrow: 1, justifyContent: 'center', gap: 24, paddingHorizontal: 16 }, navRowMobile: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 }, navTab: { minWidth: 82, alignItems: 'center', justifyContent: 'center', paddingVertical: 6 }, navTabMobile: { flex: 1, minWidth: 0, borderRadius: 12, backgroundColor: '#f4f1ea', paddingVertical: 10, paddingHorizontal: 4 }, navTabMobileActive: { backgroundColor: '#191b2a' }, navText: { color: '#1d2140', fontSize: 16, lineHeight: 20, fontWeight: '700' }, navTextMobile: { fontSize: 12, lineHeight: 16 }, navSub: { marginTop: 4, color: '#9aa0b6', fontSize: 11, lineHeight: 14, fontWeight: '700' }, navTextActive: { color: '#c89345' }, navSubActive: { color: '#6b54d4' }, navCta: { minWidth: 118, height: 44, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: '#7d38d7', paddingHorizontal: 18 }, navCtaMobile: { minWidth: 96, height: 40, paddingHorizontal: 12, borderRadius: 12 }, navCtaText: { color: '#ffffff', fontSize: 14, lineHeight: 18, fontWeight: '800' },
  heroBand: { paddingHorizontal: 14, paddingTop: 12 }, heroWrap: { minHeight: 720, justifyContent: 'space-between', borderRadius: 24, overflow: 'hidden', backgroundColor: '#121524' }, heroImage: { borderRadius: 24, opacity: 0.07 }, heroOverlay: { flex: 1, borderRadius: 24, paddingHorizontal: 24, paddingTop: 36, paddingBottom: 0, backgroundColor: 'rgba(18,21,36,0.96)', alignItems: 'center', shadowColor: '#11131f', shadowOpacity: 0.16, shadowRadius: 22, shadowOffset: { width: 0, height: 12 } }, heroOverlayMobile: { paddingHorizontal: 18, paddingTop: 22, paddingBottom: 18 }, heroContent: { width: '100%', maxWidth: 980, alignItems: 'center' }, heroBrandRow: { flexDirection: 'row', alignItems: 'center', gap: 10 }, heroLogo: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#0d1930' }, heroEyebrow: { color: '#d3b06a', fontSize: 13, lineHeight: 18, fontWeight: '800' }, heroPill: { marginTop: 18, borderRadius: 999, paddingHorizontal: 18, paddingVertical: 10, backgroundColor: '#fffaf4' }, heroPillText: { color: '#7b57ff', fontSize: 13, lineHeight: 16, fontWeight: '800' }, heroTitle: { marginTop: 22, color: '#f8f4ef', fontSize: 52, lineHeight: 60, fontWeight: '800', maxWidth: 920, textAlign: 'center' }, heroBody: { marginTop: 16, color: 'rgba(248,244,239,0.84)', fontSize: 18, lineHeight: 28, maxWidth: 860, textAlign: 'center' }, heroActions: { marginTop: 24, flexDirection: 'row', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }, heroActionsMobile: { width: '100%', gap: 12 }, heroButtonMobile: { width: '100%' }, heroShowcase: { width: '100%', maxWidth: 1080, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'center', gap: 18, marginTop: 42, paddingBottom: 0 }, heroShowcaseStack: { flexDirection: 'column', alignItems: 'center', display: 'none' }, desktopMock: { flex: 1, minWidth: 320, maxWidth: 820, borderTopLeftRadius: 18, borderTopRightRadius: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', backgroundColor: '#f8f6ff', overflow: 'hidden', shadowColor: '#0d0b28', shadowOpacity: 0.18, shadowRadius: 20, shadowOffset: { width: 0, height: 14 } }, desktopChrome: { height: 44, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, backgroundColor: '#ece7f7', borderBottomWidth: 1, borderBottomColor: 'rgba(53,38,103,0.1)' }, chromeDots: { flexDirection: 'row', gap: 8 }, chromeDot: { width: 10, height: 10, borderRadius: 5 }, desktopTitle: { color: '#6954c8', fontSize: 13, lineHeight: 16, fontWeight: '800' }, desktopBody: { alignItems: 'center', justifyContent: 'center', paddingVertical: 22, paddingHorizontal: 18 }, phoneMock: { width: 220, borderRadius: 28, backgroundColor: '#ffffff', borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 18, paddingTop: 14, paddingBottom: 18, marginBottom: 18, shadowColor: '#0d0b28', shadowOpacity: 0.18, shadowRadius: 16, shadowOffset: { width: 0, height: 10 } }, phoneNotch: { alignSelf: 'center', width: 78, height: 10, borderRadius: 999, backgroundColor: '#dfe1ef' }, phoneTitle: { marginTop: 14, color: '#6b54d4', fontSize: 18, lineHeight: 22, fontWeight: '800', textAlign: 'center' }, phoneMeta: { marginTop: 6, color: '#7a7f95', fontSize: 11, lineHeight: 15, textAlign: 'center' }, phoneList: { marginTop: 16, gap: 10 }, phoneListItem: { borderRadius: 8, backgroundColor: '#f5f4fb', padding: 10 }, phoneListTitle: { color: '#1d2140', fontSize: 13, lineHeight: 16, fontWeight: '800' }, phoneListBody: { marginTop: 5, color: '#747b92', fontSize: 11, lineHeight: 16 }, primaryCompact: { minWidth: 180, height: 54, borderRadius: 999, alignItems: 'center', justifyContent: 'center', backgroundColor: '#8c33db', paddingHorizontal: 26 }, primaryBtn: { marginTop: 22, height: 54, borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: '#c9893f' }, primaryText: { color: '#fffaf3', fontSize: 16, lineHeight: 20, fontWeight: '800' }, secondaryBtn: { minWidth: 180, height: 54, borderRadius: 999, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 26, backgroundColor: '#4f54e8' }, secondaryText: { color: '#f7faf8', fontSize: 15, lineHeight: 18, fontWeight: '800' },
