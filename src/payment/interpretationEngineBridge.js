...
const CITY_OPTIONS = [
  ...
  { key: 'yichang', label: 'Yichang', region: 'China', province: '湖北省', timezone: 'Asia/Shanghai', latitude: 30.6919, longitude: 111.2865 },
  { key: 'xiangyang', label: 'Xiangyang', region: 'China', province: '湖北省', timezone: 'Asia/Shanghai', latitude: 32.009, longitude: 112.1225 },
  { key: 'jingzhou', label: 'Jingzhou', region: 'China', province: '湖北省', timezone: 'Asia/Shanghai', latitude: 30.3348, longitude: 112.2407 },
  { key: 'changsha', label: 'Changsha', region: 'China', province: '湖南省', timezone: 'Asia/Shanghai', latitude: 28.2282, longitude: 112.9388 },
  { key: 'zhuzhou', label: 'Zhuzhou', region: 'China', province: '湖南省', timezone: 'Asia/Shanghai', latitude: 27.8274, longitude: 113.1339 },
  { key: 'xiangtan', label: 'Xiangtan', region: 'China', province: '湖南省', timezone: 'Asia/Shanghai', latitude: 27.8297, longitude: 112.9441 },
  { key: 'yueyang', label: 'Yueyang', region: 'China', province: '湖南省', timezone: 'Asia/Shanghai', latitude: 29.3573, longitude: 113.1292 },
  { key: 'chengdu', label: 'Chengdu', region: 'China', province: '四川省', timezone: 'Asia/Shanghai', latitude: 30.5728, longitude: 104.0668 },
  { key: 'mianyang', label: 'Mianyang', region: 'China', province: '四川省', timezone: 'Asia/Shanghai', latitude: 31.4675, longitude: 104.6796 },
  { key: 'deyang', label: 'Deyang', region: 'China', province: '四川省', timezone: 'Asia/Shanghai', latitude: 31.1279, longitude: 104.3979 },
  { key: 'leshan', label: 'Leshan', region: 'China', province: '四川省', timezone: 'Asia/Shanghai', latitude: 29.5522, longitude: 103.7654 },
  ...
  { key: 'zibo', label: 'Zibo', region: 'China', province: '山东省', timezone: 'Asia/Shanghai', latitude: 36.8135, longitude: 118.0548 },
  { key: 'weifang', label: 'Weifang', region: 'China', province: '山东省', timezone: 'Asia/Shanghai', latitude: 36.7068, longitude: 119.1618 },
  { key: 'jining', label: 'Jining', region: 'China', province: '山东省', timezone: 'Asia/Shanghai', latitude: 35.4149, longitude: 116.5871 },
  ...
  { key: 'yangzhou', label: 'Yangzhou', nativeLabel: '扬州', region: 'China', province: '江苏省', timezone: 'Asia/Shanghai', latitude: 32.3947, longitude: 119.4127 },
  { key: 'yancheng', label: 'Yancheng', nativeLabel: '盐城', region: 'China', province: '江苏省', timezone: 'Asia/Shanghai', latitude: 33.3474, longitude: 120.1636 },
  { key: 'huzhou', label: 'Huzhou', nativeLabel: '湖州', region: 'China', province: '浙江省', timezone: 'Asia/Shanghai', latitude: 30.8943, longitude: 120.0868 },
  { key: 'lishui', label: 'Lishui', nativeLabel: '丽水', region: 'China', province: '浙江省', timezone: 'Asia/Shanghai', latitude: 28.4676, longitude: 119.9229 },
  { key: 'putian', label: 'Putian', nativeLabel: '莆田', region: 'China', province: '福建省', timezone: 'Asia/Shanghai', latitude: 25.454, longitude: 119.0077 },
  { key: 'ningde', label: 'Ningde', nativeLabel: '宁德', region: 'China', province: '福建省', timezone: 'Asia/Shanghai', latitude: 26.6657, longitude: 119.5477 },
  { key: 'longyan', label: 'Longyan', nativeLabel: '龙岩', region: 'China', province: '福建省', timezone: 'Asia/Shanghai', latitude: 25.0751, longitude: 117.0174 },
  { key: 'jiujiang', label: 'Jiujiang', nativeLabel: '九江', region: 'China', province: '江西省', timezone: 'Asia/Shanghai', latitude: 29.7051, longitude: 116.0019 },
  { key: 'shangrao', label: 'Shangrao', nativeLabel: '上饶', region: 'China', province: '江西省', timezone: 'Asia/Shanghai', latitude: 28.4549, longitude: 117.9434 },
  { key: 'kaifeng', label: 'Kaifeng', nativeLabel: '开封', region: 'China', province: '河南省', timezone: 'Asia/Shanghai', latitude: 34.7973, longitude: 114.3076 },
  { key: 'nanyang', label: 'Nanyang', nativeLabel: '南阳', region: 'China', province: '河南省', timezone: 'Asia/Shanghai', latitude: 32.9907, longitude: 112.5283 },
  { key: 'xinxiang', label: 'Xinxiang', nativeLabel: '新乡', region: 'China', province: '河南省', timezone: 'Asia/Shanghai', latitude: 35.303, longitude: 113.9268 },
  { key: 'taian', label: 'Taian', nativeLabel: '泰安', region: 'China', province: '山东省', timezone: 'Asia/Shanghai', latitude: 36.1999, longitude: 117.0884 },
  { key: 'dezhou', label: 'Dezhou', nativeLabel: '德州', region: 'China', province: '山东省', timezone: 'Asia/Shanghai', latitude: 37.4355, longitude: 116.3593 },
  { key: 'qiqihar', label: 'Qiqihar', nativeLabel: '齐齐哈尔', region: 'China', province: '黑龙江省', timezone: 'Asia/Shanghai', latitude: 47.3543, longitude: 123.9182 },
  { key: 'jilin-city', label: 'Jilin', nativeLabel: '吉林', region: 'China', province: '吉林省', timezone: 'Asia/Shanghai', latitude: 43.8378, longitude: 126.5494 },
  { key: 'anshan', label: 'Anshan', nativeLabel: '鞍山', region: 'China', province: '辽宁省', timezone: 'Asia/Shanghai', latitude: 41.1078, longitude: 122.9946 },
  { key: 'tangshan', label: 'Tangshan', nativeLabel: '唐山', region: 'China', province: '河北省', timezone: 'Asia/Shanghai', latitude: 39.6305, longitude: 118.1802 },
  { key: 'langfang', label: 'Langfang', nativeLabel: '廊坊', region: 'China', province: '河北省', timezone: 'Asia/Shanghai', latitude: 39.5378, longitude: 116.6838 },
  { key: 'datong', label: 'Datong', nativeLabel: '大同', region: 'China', province: '山西省', timezone: 'Asia/Shanghai', latitude: 40.0768, longitude: 113.3001 },
  { key: 'linfen', label: 'Linfen', nativeLabel: '临汾', region: 'China', province: '山西省', timezone: 'Asia/Shanghai', latitude: 36.088, longitude: 111.5189 },
  { key: 'baotou', label: 'Baotou', nativeLabel: '包头', region: 'China', province: '内蒙古自治区', timezone: 'Asia/Shanghai', latitude: 40.6574, longitude: 109.8403 },
  { key: 'chifeng', label: 'Chifeng', nativeLabel: '赤峰', region: 'China', province: '内蒙古自治区', timezone: 'Asia/Shanghai', latitude: 42.266, longitude: 118.8892 },
  { key: 'fuyang-ah', label: 'Fuyang', nativeLabel: '阜阳', region: 'China', province: '安徽省', timezone: 'Asia/Shanghai', latitude: 32.8969, longitude: 115.8142 },
  { key: 'anqing', label: 'Anqing', nativeLabel: '安庆', region: 'China', province: '安徽省', timezone: 'Asia/Shanghai', latitude: 30.5435, longitude: 117.0635 },
  { key: 'beihai', label: 'Beihai', nativeLabel: '北海', region: 'China', province: '广西壮族自治区', timezone: 'Asia/Shanghai', latitude: 21.4811, longitude: 109.1202 },
  { key: 'qujing', label: 'Qujing', nativeLabel: '曲靖', region: 'China', province: '云南省', timezone: 'Asia/Shanghai', latitude: 25.4902, longitude: 103.7963 },
  { key: 'zunyi', label: 'Zunyi', nativeLabel: '遵义', region: 'China', province: '贵州省', timezone: 'Asia/Shanghai', latitude: 27.7257, longitude: 106.9274 },
  { key: 'tianshui', label: 'Tianshui', nativeLabel: '天水', region: 'China', province: '甘肃省', timezone: 'Asia/Shanghai', latitude: 34.5809, longitude: 105.7249 },
  { key: 'guyuan', label: 'Guyuan', nativeLabel: '固原', region: 'China', province: '宁夏回族自治区', timezone: 'Asia/Shanghai', latitude: 36.0159, longitude: 106.2426 },
  { key: 'shigatse', label: 'Shigatse', nativeLabel: '日喀则', region: 'China', province: '西藏自治区', timezone: 'Asia/Shanghai', latitude: 29.267, longitude: 88.8806 },
  { key: 'korla', label: 'Korla', nativeLabel: '库尔勒', region: 'China', province: '新疆维吾尔自治区', timezone: 'Asia/Urumqi', latitude: 41.7264, longitude: 86.1746 },
  { key: 'karamay', label: 'Karamay', nativeLabel: '克拉玛依', region: 'China', province: '新疆维吾尔自治区', timezone: 'Asia/Urumqi', latitude: 45.5799, longitude: 84.8892 },
  { key: 'shantou', label: 'Shantou', nativeLabel: '汕头', region: 'China', province: '广东省', timezone: 'Asia/Shanghai', latitude: 23.3541, longitude: 116.6819 },
  { key: 'zhanjiang', label: 'Zhanjiang', nativeLabel: '湛江', region: 'China', province: '广东省', timezone: 'Asia/Shanghai', latitude: 21.2707, longitude: 110.3594 },
  { key: 'maoming', label: 'Maoming', nativeLabel: '茂名', region: 'China', province: '广东省', timezone: 'Asia/Shanghai', latitude: 21.6627, longitude: 110.9255 },
  { key: 'jieyang', label: 'Jieyang', nativeLabel: '揭阳', region: 'China', province: '广东省', timezone: 'Asia/Shanghai', latitude: 23.5497, longitude: 116.3727 },
  { key: 'baoji', label: 'Baoji', nativeLabel: '宝鸡', region: 'China', province: '陕西省', timezone: 'Asia/Shanghai', latitude: 34.3619, longitude: 107.2377 },
  { key: 'xianyang', label: 'Xianyang', nativeLabel: '咸阳', region: 'China', province: '陕西省', timezone: 'Asia/Shanghai', latitude: 34.3296, longitude: 108.7088 },
